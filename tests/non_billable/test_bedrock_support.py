...
def _make_response(body_bytes: bytes | None = None) -> HTTPResponse:
    ...
    return HTTPResponse(
        ...
        request_method="POST",
        request_url="https://bedrock-runtime.us-east-1.amazonaws.com/model/amazon.nova-lite-v1:0/converse",
    )
...
def test_urllib3_api_parser_round_trips_bedrock_request_and_response():
    ...
    assert input_payload["raw"]["url"].endswith("/model/amazon.nova-lite-v1:0/converse")
...
def test_patch_urllib3_urlopen_intercepts_bedrock_and_uses_cache_flow(monkeypatch):
    ...
    assert captured["full_url"].endswith("/model/amazon.nova-lite-v1:0/converse")
