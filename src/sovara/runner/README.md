...
When the user runs `so-record script.py` (instead of `python script.py`), they create an AgentRunner instance that runs their script.
...
The matching algorithm is implemented in [string_matching.py](/src/sovara/runner/string_matching.py).
