...
from ao.server.state import ServerState
...
async def lifespan(app: FastAPI):
    ...
    # Wire up uvicorn server reference for clean shutdown (set by ao_server.py)
...
def create_app() -> FastAPI:
    ...
    from ao.server.routes.runner import router as runner_router
    from ao.server.routes.ui import router as ui_router
    from ao.server.routes.events import router as events_router
