...
# This works around vsce's inability to handle npm workspace monorepos
# where webpack embeds paths like ../shared_components/ in the bundle

set -e

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
TEMP_DIR=$(mktemp -d)
EXTENSION_NAME="ao-agent-dev"
